...
cls
cmd /c DepotDownloader\DepotDownloader.exe -app 413150 -depot 413151 -manifest 2373680906867811602 -username %user_name% -password %user_password% -dir SDV1.4 -remember-password
